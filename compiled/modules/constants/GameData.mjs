...
export class WorldData {
    ...
    static SLOPES = ["slope-floor-right", "slope-floor-left", "slope-ceiling-right", "slope-ceiling-left"];
    static STRING_TILE_TYPES = ["empty", "platform"];
...
export class SpikeballData {
    ...
    static SHATTER_PARTICLE_SETTINGS = {
        color: { red: 0, green: 0, blue: 0 },
        size: 1,
        opacityDecay: 1 / 15,
...
export class SpiderData {
    ...
    static PROJECTILE_PARTICLE_SETTINGS = {
        color: { red: 255, green: 128, blue: 0 },
        size: { min: 15, max: 20 },
        shape: 3,
        glowSize: 30,
...
//# sourceMappingURL=GameData.mjs.map