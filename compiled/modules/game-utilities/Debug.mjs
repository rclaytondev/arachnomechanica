...
export class Debug {
    ...
    static checkRNGLogging(canvasIO) {
    ...
    static initializeEditor() {
        const room = ((typeof DEBUG_SETTINGS.EDITOR.ROOM === "number") ? ROOMS[DEBUG_SETTINGS.EDITOR.ROOM]
    ...
    static displayFramerate(canvasIO) {
    ...
    static displayMouseCoordinates(canvasIO, camera, display = DEBUG_SETTINGS.SHOW_MOUSE_COORDINATES) {
        if (!display) {
            return;
        }
    ...
    static updateFreeCameraMode(camera) {
