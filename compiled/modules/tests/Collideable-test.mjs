...
class CollideableSpy extends RectangularCollideable {
    ...
    collisions = 0;
    destroyed = false;
    amountTranslated = new Vector(0, 0);
    constructor(hitbox, name, pushable, crushable = pushable) {
        super(hitbox);
        this.name = name;
...
describe("Collideable.moveUnit", () => {
    const createWorld = (collideables, tiles = []) => {
...
//# sourceMappingURL=Collideable-test.mjs.map