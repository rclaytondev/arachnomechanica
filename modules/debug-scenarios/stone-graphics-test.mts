...
world.tiles.set(8, -3, new StoneSlope("slope-floor-right"));
world.tiles.set(8, -2, StoneTile.STONE_TILE);
world.tiles.set(9, -3, StoneTile.STONE_TILE);


world.tiles.set(2, -6, new StoneSlope("slope-floor-right"));
world.tiles.set(3, -6, new StoneSlope("slope-floor-left"));
