...
export const gateScenario = new TestScenario(() => {
	...
	world.entities.add(Gate.atTile(new Vector(-4, -5), "left", false));
	world.tiles.set(-5, -5, TowerTile.TOWER_TILE);

	world.tiles.set(6, 0, TowerTile.TOWER_TILE);
	world.entities.add(Gate.atTile(new Vector(4, 0), "right", true));
	world.entities.add(Gate.atTile(new Vector(5, 0), "left", true));
