...
world.tiles.fillRect(new Rectangle(-2, 0, 10, 1), new BasicTile());
...
world.tiles.set(-3, -3, new BasicTile());
world.tiles.fillRect(new Rectangle(-6, -2, 5, 1), new BasicTile());
...
world.tiles.set(8, -2, new BasicTile());
world.tiles.set(9, -3, new BasicTile());
